...
<section class="main">
	...
	<?php if(get_field('meetup_save_the_date_headline')) : ?>
	<div class="save-the-date">
		<div class="container">
			<h2 class="with-line"><?php the_field('meetup_save_the_date_headline'); ?></h2>
			<div class="bigger-text"><?php the_field('meetup_save_the_date_text'); ?></div>
			<div class="the-date">
				<span class="day"><?php the_field('meetup_save_the_date_tag'); ?></span>
				<span class="month"><?php the_field('meetup_save_the_date_monat'); ?></span>
				<span class="year"><?php the_field('meetup_save_the_date_jahr'); ?></span>
			</div><br><br>

			<div class="bigger-text"><p><?php the_field('meetup_save_the_date_datum_text'); ?></p></div>

            <?php if(get_field('meetup_button_1_text')) : ?>

                <a href="<?php the_field('meetup_button_1_link'); ?>" title="<?php the_field('meetup_button_1_text'); ?>" class="button-primary">
                    <?php the_field('meetup_button_1_text'); ?>
                </a>

            <?php endif; ?>

            <?php if(get_field('meetup_button_2_text')) : ?>

                <a href="<?php the_field('meetup_button_2_link'); ?>" title="<?php the_field('meetup_button_2_text'); ?>" class="button-secondary">
                    <?php the_field('meetup_button_2_text'); ?>
                </a>
